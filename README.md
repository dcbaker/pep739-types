...
- `PEP739_v1`: This is a union of all possible PEP 739 revisions of major version
  1, i.e., 1.1, 1.2. Each revision has its schema as a constant of
  `Literal['X.Y']`, so it should be possible to differentiate the union based on
  that.
...
knows that they only will use version 1.0, they can import `pep739.v1_0.PEP739`.
